...
const Skills = (): React.ReactElement => {
  return (
    <>
      ...
      lg:bg-circularLightLargeScreen lg:dark:bg-circularDarkLargeScreen
      md:bg-circularLightMediumScreen md:dark:bg-circularDarkMediumScreen
      sm:bg-circularLightSmallScreen sm:dark:bg-circularDarkSmallScreen"
      >
        <motion.div
